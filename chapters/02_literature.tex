...
% - plagiarism
The objectives for this analysis may vary from plagiarism detection~\cite{TODO} where the occurrence of text pieces too similar is an indication of non-originality.
...
Once these models synthesise documents of different length into numeric representations, there are different geometrical measures that can be used to compute the distance / similarity.
Euclidean / cosine /
