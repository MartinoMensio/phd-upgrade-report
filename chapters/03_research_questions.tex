...
\begin{itemize}
    ...
    \item \textbf{RQ1.3: Which features reveal intentionality of linguistic choices?} Choosing terms sometimes is done with a specific intention to evoke or amplify a certain point, sometimes it is not.\todo{merge with RQ1.2?}
