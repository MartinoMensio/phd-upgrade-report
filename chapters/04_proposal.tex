...
As we have seen in section~\ref{sec:lit_framing}, different manifestations have been theorised and experimented in practice.
...
And the strategic omission or inclusion of certain details that have the role of shifting the opinion of the reader.
...
For this reason, we want to test how important it is to see multiple articles that treat the same event to discover their point of view through the signals used in the text.
...
The model will provides as outputs span annotations that will say which framing techniques have been used.
...
In the metadata of the articles usually it is present the publishing date and sometimes also the precise minute.
