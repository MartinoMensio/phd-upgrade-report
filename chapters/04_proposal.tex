...
To address the first Research Question (revealing the framing differences in articles presenting the same event), we aim to automatically identify \textit{signals of framing} that otherwise would not be noticeable: %on top of this representation,
...
\subsection{Cross-article Signals (Text2Story)}
