...
To address the first Research Question \textbf{(revealing the framing differences in articles presenting the same event)}\todo{rewrite here RQ1 as question}, we aim to automatically identify \textit{signals of framing} that otherwise would not be noticeable: %on top of this representation,
...
The expansion and refinement of these signals will help us answer the first Research Question.
Hypothesis: 
