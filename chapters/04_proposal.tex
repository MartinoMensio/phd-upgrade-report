...
% CA1(before)+CA2 for U1 and CA1+CA2(before) for U2 where each observation is done at first sight of the corresponding article (see Figure~\ref{fig:user_study}).
...
A source can have a certain political alignment, be part of a certain newsgroup, have an affiliation to certain movements and ideals, or reside in a certain country, and we want to do an analysis of the framing techniques across all these features.
