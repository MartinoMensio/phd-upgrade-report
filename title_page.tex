\begin{titlepage}
    \begin{center}
        ...
        % \centering
        % \savebox{\largestimage}{\includegraphics[width=0.4\textwidth]{images/OU-logo-2017.eps}}
        % \usebox{\largestimage}
        % \hfill
        % \raisebox{\dimexpr.5\ht\largestimage-.5\height}{\includegraphics[width=0.4\textwidth]{images/kmi-logo.eps}}
